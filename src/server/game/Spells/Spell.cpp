        ...
        case TARGET_DEST_CASTER_FRONT_LEAP:
            {
                ...
                else
                {
                    ...
                    bool col = VMAP::VMapFactory::createOrGetVMapMgr()->GetObjectHitPos(mapid, pos.GetPositionX(), pos.GetPositionY(), z + 0.2f, destx, desty, z + 0.2f, destx, desty, z, -0.5f);
                    // check dynamic collision
                    bool dcol = m_caster->GetMap()->GetObjectHitPos(phasemask, pos.GetPositionX(), pos.GetPositionY(), z + 0.2f, destx, desty, z + 0.2f, destx, desty, z, -0.5f);
